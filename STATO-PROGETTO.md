...
Versione corrente: **1.5.7** (allineata in `app/__init__.py`, `installer/sonora.iss` e GitHub).
...
- Installer: `"%LOCALAPPDATA%\Programs\Inno Setup 6\ISCC.exe" installer\sonora.iss` → `dist_installer/SonoraSetup-1.5.7.exe`
