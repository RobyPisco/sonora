...
![python](https://img.shields.io/badge/python-3.14-blue) ![gui](https://img.shields.io/badge/GUI-PySide6-green) ![version](https://img.shields.io/badge/versione-1.5.7-orange)
...
4. Output: `dist_installer\SonoraSetup-1.5.7.exe`
...
3. Compile: `ISCC.exe installer\sonora.iss` → `dist_installer\SonoraSetup-1.5.7.exe`.
